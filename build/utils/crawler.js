...
var superagent_1 = __importDefault(require("superagent")); // ts cannot read js file
var fs_1 = __importDefault(require("fs")); // from node
var path_1 = __importDefault(require("path")); // from node
// common logic
var Crawler = /** @class */ (function () {
    function Crawler(url, fileName, analyzer) {
        this.url = url;
